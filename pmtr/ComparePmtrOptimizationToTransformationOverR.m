function ComparePmtrOptimizationToTransformationOverR(OriginalONEileLinks,InferredONEFolder,RVector,ChosenR, Pattern);
...
for R = RVector
    ...
    for t = 1:tm
        ...
        LinkErrorsTrans(t) = ExtraLinksTrans(t) + MissingLinksTrans(t) / NormValue;
